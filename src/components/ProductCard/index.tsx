...
const ProductCard = ({ }: IProps) => {
    return (
        <div className="bg-gray-100 p-4 border-2 border-gray-300 rounded-md">
            <div className="overflow-hidden mb-3">
                <Image imageUrl="https://plus.unsplash.com/premium_photo-1683865776032-07bf70b0add1?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" altText="Product Image" className="object-cover rounded-md" />
            </div>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between space-x-3">
                    <div className="w-10 h-10">
                        <Image imageUrl="https://plus.unsplash.com/premium_photo-1683865776032-07bf70b0add1?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" altText="Seller Image" className="w-full h-full object-cover rounded-full" />
                    </div>
                    <div>
                        Cars
                    </div>
